...
driver.get('http://walle.zhulong.com:8484/login')
time.sleep(1);
...
time.sleep(1);
driver.get('http://walle.zhulong.com:8484/%E7%AD%91%E9%BE%99%E5%AD%A6%E7%A4%BE/task/create/60')
time.sleep(2);
...
for i in inputs:
    if i.get_attribute("placeholder") == "选取Tag":
    	...
    	text=el[1].find_element_by_tag_name("span").text
    	driver.find_elements_by_class_name("el-input__inner")[0].send_keys(text)
    	el[1].find_element_by_tag_name("span").click()
    	break
driver.find_elements_by_class_name("el-button")[1].click()
time.sleep(2);
driver.get('http://walle.zhulong.com:8484/%E7%AD%91%E9%BE%99%E5%AD%A6%E7%A4%BE/deploy/index')
time.sleep(2);
